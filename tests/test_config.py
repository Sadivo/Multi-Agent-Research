"""
Tests for config.py, requirements.txt, and .env.example.
...
# Feature: multi-agent-research-pipeline, Property 11: 缺少環境變數時輸出明確錯誤
# Validates: Requirements 10.3
# ══════════════════════════════════════════════════════════════════════════

@settings(max_examples=100)
@given(st.sampled_from(REQUIRED_ENV_VARS))
def test_missing_env_var_shows_clear_error(missing_var):
    """
    **Validates: Requirements 10.3**
    ...
    """
    # Build an env dict with all required vars present, then remove one
